...
const services = [
  { icon: "🤖", title: "AI Chatbots & Virtual Assistants", description: "Intelligent chatbots that answer property questions, qualify leads, schedule showings, and capture contact information 24/7 — so you never miss an opportunity." },
  { icon: "📞", title: "AI Voice Assistants", description: "Conversational AI that handles inbound and outbound calls, follows up with leads, confirms appointments, and provides property details in natural human-like dialogue." },
  { icon: "🎯", title: "Automated Lead Qualification", description: "AI-driven scoring and qualification systems that analyze lead behavior, budget, timeline, and intent to prioritize the hottest prospects for your team." },
  { icon: "📊", title: "Predictive Analytics", description: "Machine learning models that forecast market trends, identify likely sellers, predict listing prices, and surface the highest-converting neighborhoods for your campaigns." },
  { icon: "⚡", title: "Workflow Automation", description: "End-to-end automation of repetitive tasks: drip campaigns, follow-up sequences, CRM updates, transaction coordination, and document management — all on autopilot." },
  { icon: "🧠", title: "Smart Content Generation", description: "AI-assisted listing descriptions, market reports, social media captions, email copy, and blog outlines that maintain your brand voice while saving hours every week." },
];
...
export default function AIAutomationPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-violet-600 via-purple-700 to-violet-900 pt-32 pb-28">
        <div className="absolute inset-0 opacity-10" style={{ backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.4'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")" }} />
        <div className="pointer-events-none absolute -top-24 -left-24 h-96 w-96 rounded-full bg-violet-400/20 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-32 -right-32 h-[500px] w-[500px] rounded-full bg-purple-400/20 blur-3xl" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <nav className="flex justify-center mb-6 text-violet-200 text-sm">
          ...
          <p className="text-xl text-violet-100 max-w-3xl mx-auto mb-10 leading-relaxed">Chatbots, voice assistants, predictive analytics, and workflow automation that qualify leads, book showings, and close deals — even while you sleep.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="bg-white text-violet-700 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-violet-50 transition-all shadow-lg shadow-violet-900/20 hover:shadow-xl hover:-translate-y-0.5">Get Your Free AI Audit</Link>
          ...
          <p className="mt-6 text-violet-200/70 text-sm">Join 200+ real estate teams using our AI solutions</p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-4">
        <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm text-gray-400">
          {["GPT-4 & Claude Powered", "Real Estate–Trained Models", "CRM Integration Ready", "SOC 2 Compliant"].map((item, i) => (
            <span key={i} className="flex items-center gap-2"><svg className="w-5 h-5 text-violet-500" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg> {item}</span>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <span className="text-violet-600 font-semibold text-sm uppercase tracking-wider">Our Solutions</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((s, i) => (
            <div key={i} className="group bg-white border border-gray-100 rounded-2xl p-8 hover:border-violet-200 hover:shadow-lg hover:shadow-violet-100/50 transition-all duration-300">
              <div className="w-14 h-14 bg-gradient-to-br from-violet-50 to-purple-100 rounded-2xl flex items-center justify-center text-2xl mb-5 group-hover:scale-110 transition-transform duration-300">{s.icon}</div>
      ...
      <section className="bg-gradient-to-br from-gray-900 to-gray-800 py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-violet-400 font-semibold text-sm uppercase tracking-wider">Proven Results</span>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-violet-600 font-semibold text-sm uppercase tracking-wider">Why AI Automation</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((b, i) => (
              <div key={i} className="bg-violet-50/50 border border-violet-100 rounded-2xl p-6 hover:bg-violet-50 transition-colors">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((t, i) => (
              <div key={i} className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 relative">
                ...
                <div><div className="font-bold text-gray-900">{t.author}</div><div className="text-violet-600 text-sm">{t.role}</div></div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center mb-16">
          <span className="text-violet-600 font-semibold text-sm uppercase tracking-wider">Our Process</span>
        ...
        <div className="relative">
          <div className="hidden md:block absolute top-6 left-[10%] right-[10%] h-0.5 bg-gradient-to-r from-violet-200 via-violet-400 to-violet-200" />
          <div className="grid md:grid-cols-5 gap-8">
            {steps.map((s) => (
              <div key={s.step} className="text-center relative">
                <div className="w-12 h-12 bg-violet-600 text-white rounded-full flex items-center justify-center text-lg font-bold mx-auto mb-4 relative z-10 shadow-lg shadow-violet-200">{s.step}</div>
      ...
      <section className="bg-gray-50 border-y border-gray-100 py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <details key={i} className="group bg-white rounded-2xl border border-gray-100 hover:border-violet-200 transition-colors">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-violet-600 font-semibold text-sm uppercase tracking-wider">Related Services</span>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-3">Supercharge Your AI Strategy</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {relatedServices.map((rs, i) => (
              <Link key={i} href={rs.href} className="group bg-white border border-gray-100 rounded-2xl p-8 hover:border-violet-200 hover:shadow-lg hover:shadow-violet-50 transition-all block">
                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-violet-600 transition-colors">{rs.title}</h3>
                <p className="text-gray-500 leading-relaxed mb-4">{rs.description}</p>
                <span className="text-violet-600 font-semibold text-sm inline-flex items-center gap-1 group-hover:gap-2 transition-all">Learn more <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg></span>
              </Link>
            ))}
          </div>
        </div>
      ...
      {/* CTA */}
      <section className="relative overflow-hidden bg-gradient-to-br from-violet-600 via-purple-700 to-violet-900 py-24">
        <div className="pointer-events-none absolute -top-24 -right-24 h-96 w-96 rounded-full bg-violet-400/20 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-24 -left-24 h-96 w-96 rounded-full bg-purple-400/20 blur-3xl" />
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-violet-100 mb-10 max-w-2xl mx-auto leading-relaxed">Book a free AI readiness audit and discover how automation can transform your lead conversion, save your team hours every day, and accelerate your growth.</p>
          <Link href="/contact" className="inline-block bg-white text-violet-700 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-violet-50 transition-all shadow-lg shadow-violet-900/20 hover:shadow-xl hover:-translate-y-0.5">Get Your Free AI Audit</Link>
          <p className="mt-6 text-violet-200/60 text-sm">Includes a custom automation roadmap and ROI projection</p>
        </div>
      </section>
