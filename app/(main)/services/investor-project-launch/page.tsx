...
export default function InvestorProjectLaunchPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-orange-600 via-red-700 to-orange-900 pt-32 pb-28">
        ...
        <div className="pointer-events-none absolute -bottom-32 -right-32 h-[500px] w-[500px] rounded-full bg-red-400/20 blur-3xl" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-orange-100 max-w-3xl mx-auto mb-10 leading-relaxed">Full-service launch campaigns for developers, investors, and new construction projects. From pre-launch buzz to sell-out — we build pipelines, position brands, and drive sales velocity.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="bg-white text-orange-700 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-orange-50 transition-all shadow-lg shadow-orange-900/20 hover:shadow-xl hover:-translate-y-0.5">Get Your Launch Strategy</Link>
          ...
          <p className="mt-6 text-orange-200/70 text-sm">45+ projects launched with $850M+ in combined value</p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-4">
        <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm text-gray-400">
          {["Luxury & Mid-Market Projects", "Pre-Construction Specialists", "Accredited Investor Networks", "Full-Service Launch Execution"].map((item, i) => (
            <span key={i} className="flex items-center gap-2"><svg className="w-5 h-5 text-orange-500" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg> {item}</span>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <span className="text-orange-600 font-semibold text-sm uppercase tracking-wider">Our Solutions</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((s, i) => (
            <div key={i} className="group bg-white border border-gray-100 rounded-2xl p-8 hover:border-orange-200 hover:shadow-lg hover:shadow-orange-100/50 transition-all duration-300">
              <div className="w-14 h-14 bg-gradient-to-br from-orange-50 to-red-100 rounded-2xl flex items-center justify-center text-2xl mb-5 group-hover:scale-110 transition-transform duration-300">{s.icon}</div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-orange-600 font-semibold text-sm uppercase tracking-wider">Why Launch with Us</span>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((t, i) => (
              <div key={i} className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 relative">
                ...
                <div><div className="font-bold text-gray-900">{t.author}</div><div className="text-orange-600 text-sm">{t.role}</div></div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CTA */}
      <section className="relative overflow-hidden bg-gradient-to-br from-orange-600 via-red-700 to-orange-900 py-24">
        <div className="pointer-events-none absolute -top-24 -right-24 h-96 w-96 rounded-full bg-orange-400/20 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-24 -left-24 h-96 w-96 rounded-full bg-red-400/20 blur-3xl" />
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-orange-100 mb-10 max-w-2xl mx-auto leading-relaxed">Book a free launch strategy session. We&apos;ll analyze your project, market, and competition — then map out a campaign that maximizes pre-sales and accelerates absorption.</p>
          <Link href="/contact" className="inline-block bg-white text-orange-700 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-orange-50 transition-all shadow-lg shadow-orange-900/20 hover:shadow-xl hover:-translate-y-0.5">Get Your Free Launch Strategy</Link>
          <p className="mt-6 text-orange-200/60 text-sm">Includes a custom market analysis and launch timeline</p>
        </div>
      </section>
