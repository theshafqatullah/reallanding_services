    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-green-600 via-emerald-700 to-green-900 pt-32 pb-28">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 max-w-3xl mx-auto mb-10 leading-relaxed">From first-time buyers to seasoned investors, our expert buyer&apos;s agents guide you through every step — finding the right property, negotiating the best deal, and closing with confidence.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="bg-white text-green-700 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-green-50 transition-all shadow-lg shadow-green-900/20 hover:shadow-xl hover:shadow-green-900/30 hover:-translate-y-0.5">Start Your Home Search</Link>
          ...
          <p className="mt-6 text-green-200/70 text-sm">Trusted by 1,200+ happy homeowners across the US</p>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-green-600 via-emerald-700 to-green-900 py-24">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 mb-10 max-w-2xl mx-auto leading-relaxed">Book a free buyer&apos;s consultation and let our experts build a personalized home search strategy — so you can stop scrolling and start touring.</p>
          ...
          <p className="mt-6 text-green-200/60 text-sm">No commitment required — get a personalized home buying plan in 30 minutes</p>
        </div>
      </section>
