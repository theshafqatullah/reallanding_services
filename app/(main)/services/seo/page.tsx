...
const services = [
  { icon: "📍", title: "Local SEO & Google Business Profile", description: "Dominate the local map pack and 'near me' searches so buyers and sellers in your area find you first. We optimize your GBP listing, manage reviews, build local citations, and ensure consistent NAP data across 60+ directories." },
  { icon: "📝", title: "On-Page Optimization", description: "Every page on your site is meticulously optimized — from title tags and meta descriptions to header hierarchy, internal linking structure, image alt text, and schema markup for rich search results." },
  { icon: "⚙️", title: "Technical SEO & Core Web Vitals", description: "We audit and fix site speed issues, eliminate crawl errors, implement structured data, optimize for mobile-first indexing, and ensure your site architecture helps search engines discover every property page." },
  { icon: "✍️", title: "Content & Blog Strategy", description: "Data-driven neighborhood guides, monthly market reports, homebuyer resources, and long-form authority content that attracts organic traffic and positions you as the local expert buyers and sellers trust." },
  { icon: "🔗", title: "Link Building & Digital PR", description: "White-hat backlink acquisition from real estate directories, local media outlets, industry publications, and community organizations that boost your domain authority and drive referral traffic." },
  { icon: "🔍", title: "Keyword Research & Mapping", description: "Deep analysis of search intent — from 'homes for sale in [city]' to long-tail neighborhood queries and investor-focused terms — mapped strategically across your entire site architecture." },
];
