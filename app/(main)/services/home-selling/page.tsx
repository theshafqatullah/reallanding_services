...
const services = [
  { icon: (<svg className="w-7 h-7 text-green-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>), title: "Pricing Strategy & Market Analysis", description: "We analyze comparable sales, active competition, neighborhood trends, and buyer demand to determine the optimal listing price. positioning your home to attract maximum interest while protecting your equity." },
  { icon: (<svg className="w-7 h-7 text-green-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 7.125C2.25 6.504 2.754 6 3.375 6h6c.621 0 1.125.504 1.125 1.125v3.75c0 .621-.504 1.125-1.125 1.125h-6a1.125 1.125 0 01-1.125-1.125v-3.75zM14.25 8.625c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v8.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 01-1.125-1.125v-8.25z" /></svg>), title: "Staging Consultation & Design", description: "Our certified staging consultants transform your property into a buyer magnet. decluttering, rearranging, and adding strategic touches that highlight your home&apos;s best features and help buyers envision their future life there." },
  { icon: (<svg className="w-7 h-7 text-green-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.774 48.774 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z" /><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z" /></svg>), title: "Professional Photography & Media", description: "HDR photography, twilight shots, aerial drone footage, 3D virtual tours, and cinematic video walk-throughs that make your listing stand out in a sea of iPhone photos and generate 3× more showing requests." },
  { icon: (<svg className="w-7 h-7 text-green-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38c-.551.318-1.26.117-1.527-.461a20.845 20.845 0 01-1.44-4.282m3.102.069a18.03 18.03 0 01-.59-4.59c0-1.586.205-3.124.59-4.59m0 9.18a23.848 23.848 0 018.835 2.535M10.34 6.66a23.847 23.847 0 008.835-2.535m0 0A23.74 23.74 0 0018.795 3m.38 1.125a23.91 23.91 0 011.014 5.395m-1.014 8.855c-.118.38-.245.754-.38 1.125m.38-1.125a23.91 23.91 0 001.014-5.395m0-3.46c.495.413.811 1.035.811 1.73 0 .695-.316 1.317-.811 1.73m0-3.46a24.347 24.347 0 010 3.46" /></svg>), title: "Listing Management & Marketing", description: "Your property goes live across MLS, Zillow, Realtor.com, Redfin, social media, email campaigns, and our exclusive buyer network. with optimized descriptions, strategic timing, and targeted digital advertising." },
  { icon: (<svg className="w-7 h-7 text-green-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>), title: "Buyer Qualification & Showings", description: "We pre-screen every buyer for financial readiness before scheduling showings, manage open houses, collect real-time feedback, and ensure only serious, qualified prospects tour your property." },
  { icon: (<svg className="w-7 h-7 text-green-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M7.5 3.75H6A2.25 2.25 0 003.75 6v1.5M16.5 3.75H18A2.25 2.25 0 0120.25 6v1.5m0 9V18A2.25 2.25 0 0118 20.25h-1.5m-9 0H6A2.25 2.25 0 013.75 18v-1.5M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>), title: "Negotiation & Closing Coordination", description: "From reviewing offers and negotiating counterterms to managing inspections, appraisals, and title work. We handle every detail through closing day so you net the highest possible price with minimal stress." },
];
...
const benefits = [
  ...
  { title: "Stress-Free Process", desc: "From staging to closing, your dedicated listing agent handles every , including showings, feedback, offers, inspections, appraisals, and paperwork, so you can focus on your next chapter." },
];
...
export default function HomeSellingPage() {
  return (
    <ServicePageLayout data={{
      ...
      badgeText: "Full-Service Home Selling Solutions",
      title: `Sell Your Home Faster &<br className="hidden md:block" /> For the Highest Possible Price`,
      description: `From pricing strategy and professional staging to aggressive marketing and expert negotiation. We handle every detail so you net more money, close faster, and move on with confidence.`,
      primaryCTA: "Get Your Free Home Valuation",
      secondaryCTA: "See Our Selling Results",
      trustLine: "Trusted by 2,400+ homeowners who sold for top dollar",
      trustBar: ["Top 1% Listing Agents", "Professional Staging Included", "Multi-Channel Marketing", "No Lock-In Contracts"],
      stats,
      services,
      servicesHeading: "Our Services",
      servicesSubheading: `Everything You Need to Sell for Top Dollar`,
      servicesDescription: `Six core services that work together to maximize your sale price, minimize your time on market, and make the entire selling experience seamless.`,
      results,
      resultsHeading: "Proven Results",
      resultsSubheading: `Selling Success. By the Numbers`,
      resultsDescription: `Here's what happens when you combine strategic pricing, professional presentation, and aggressive marketing with expert negotiation.`,
      benefits,
      benefitsHeading: "Why Choose Us",
      benefitsSubheading: `The RealLanding Selling Advantage`,
      benefitsDescription: `Six powerful reasons our sellers consistently get higher prices, faster closings, and a stress-free experience from listing to sold.`,
      testimonials,
      testimonialHeading: "What Our Sellers Say",
      steps,
      processHeading: "Our Process",
      processSubheading: `From Listing to SOLD in Five Steps`,
      processDescription: `A proven, results-driven process that maximizes your sale price and minimizes your time on market. every single time.`,
      faqs,
      faqHeading: `Common Home Selling Questions`,
      relatedServices,
      relatedHeading: "Related Services",
      relatedSubheading: `Maximize Your Selling Success`,
      ctaHeading: `Ready to Sell Your Home for Top Dollar?`,
      ctaDescription: `Get a free, no-obligation home valuation and discover exactly what your property is worth in today's market. plus a custom selling strategy to maximize your net proceeds.`,
      ctaCTA: "Get Your Free Home Valuation",
      ctaSubtext: "No commitment required. get your personalized valuation in 24 hours",
    }} />
  );
}
