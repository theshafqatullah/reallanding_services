    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-green-600 via-emerald-700 to-green-900 pt-32 pb-28">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 max-w-3xl mx-auto mb-10 leading-relaxed">Multi-channel lead generation built for real estate agents and teams. Get a predictable, scalable pipeline of buyer and seller leads — exclusive to you, never shared.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="bg-white text-green-700 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-green-50 transition-all shadow-lg shadow-green-900/20 hover:shadow-xl hover:-translate-y-0.5">Get Your Free Lead Gen Strategy</Link>
          ...
          <p className="mt-6 text-green-200/70 text-sm">50,000+ exclusive leads generated for agents and teams nationwide</p>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-green-600 via-emerald-700 to-green-900 py-24">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 mb-10 max-w-2xl mx-auto leading-relaxed">Book a free lead generation strategy session. We&apos;ll analyze your market, identify the highest-ROI channels, and map out a plan to deliver consistent, qualified leads every month.</p>
          <Link href="/contact" className="inline-block bg-white text-green-700 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-green-50 transition-all shadow-lg shadow-green-900/20 hover:shadow-xl hover:-translate-y-0.5">Get Your Free Lead Gen Strategy</Link>
          <p className="mt-6 text-green-200/60 text-sm">Includes a custom channel recommendation and ROI projection</p>
        </div>
      </section>
